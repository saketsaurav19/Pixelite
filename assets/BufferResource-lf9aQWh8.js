import{y as U,z as g,A as S,v as I,w as h}from"./index-XcHhhxNC.js";import{S as c}from"./RenderTargetSystem-Bx6a9cMb.js";import{B as _,a as m}from"./Geometry-CoEmTnsx.js";const x={name:"local-uniform-bit",vertex:{header:`
...
`);return new Function("uv","data","dataInt32","offset",o)}function v(e,t){return`
    ...
    `}const F={f32:`
        ...
        for (let i = 0; i < 16; i++) {
            data[offset + i] = v[i];
        }`,"mat3x2<f32>":v(3,2),"mat4x2<f32>":v(4,2),"mat2x3<f32>":v(2,3),"mat4x3<f32>":v(4,3),"mat2x4<f32>":v(2,4),"mat3x4<f32>":v(3,4)},z={...F,"mat2x2<f32>":`
        data[offset] = v[0];
        data[offset + 1] = v[1];
        data[offset + 2] = v[2];
        data[offset + 3] = v[3];
    `};class N extends I{constructor({buffer:t,offset:a,size:r}){super(),this.uid=h("buffer"),this._resourceType="bufferResource",this._touched=0,this._resourceId=h("resource"),this._bufferResource=!0,this.destroyed=!1,this.buffer=t,this.offset=a|0,this.size=r,this.buffer.on("change",this.onBufferChange,this)}onBufferChange(){this._resourceId=h("resource"),this.emit("change",this)}destroy(t=!1){this.destroyed=!0,t&&this.buffer.destroy(),this.emit("change",this),this.buffer=null,this.removeAllListeners()}}export{N as B,l as G,w as U,x as a,F as b,P as c,p as d,k as e,O as f,B as g,D as l,R as t,z as u};
