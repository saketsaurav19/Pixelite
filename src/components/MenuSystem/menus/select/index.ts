...
export const selectMenu: MenuItem[] = [
  ...
  { label: 'Sky', action: (s) => console.log('Select Sky (AI feature)') },
  { label: 'Remove Background', action: () => window.dispatchEvent(new CustomEvent('remove-background')) },
  { label: 'Color Range...', action: (s) => console.log('Color Range dialog') },
  ...
  { label: 'Transform Selection', action: (s) => console.log('Transform selection mode') },
];
