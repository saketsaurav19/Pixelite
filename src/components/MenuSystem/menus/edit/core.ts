...
export const editCoreMenu: MenuItem[] = [
  ...
  { divider: true },
  { label: 'Cut', shortcut: 'Ctrl+X', action: (s) => console.log('Cut') },
  { label: 'Copy', shortcut: 'Ctrl+C', action: (s) => console.log('Copy') },
  { label: 'Copy Merged', shortcut: 'Shift+Ctrl+C', action: (s) => console.log('Copy Merged') },
  { label: 'Paste', shortcut: 'Ctrl+V', action: (s) => console.log('Paste') },
];
